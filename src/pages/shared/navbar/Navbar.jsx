...
const Navbar = () => {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem('jutoodCraftsTheme');
    if (savedTheme) { setTheme(savedTheme) }
  }, []);

  useEffect(() => {
    localStorage.setItem('jutoodCraftsTheme', theme);
    const savedTheme = localStorage.getItem('jutoodCraftsTheme');
      ...
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end">
          ...
          <label className="swap swap-rotate ml-3">
            ...
            <input id="theme-controller" onChange={handleThemeToggle} type="checkbox" className="theme-controller" checked={theme === 'dark' ? true : false} />
